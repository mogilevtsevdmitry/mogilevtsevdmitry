...
Статистика строится внутри репозитория GitHub Actions и сохраняется локально в SVG. Архивные репозитории не учитываются, поэтому блок показывает актуальную активную часть профиля и не зависит от внешних сервисов статистики.
